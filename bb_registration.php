...
?>
    <form class="form" action="" method="post">
        ...
        <input type="text" class="login-input" minlength="10" maxlength="10" name="bbmno" placeholder="Contact Number (Blood Bank)">
          Approved by State Medical Council (SMC):<br><br>
          ...
          <input type="submit" name="submit" value="Register" class="login-button" style="font-size:20px">
          <br><br><br>
