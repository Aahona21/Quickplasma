...
<?php
    ...
    if (isset($_REQUEST['hlname'])) {
        ...
        No_of_beds,No_of_wards,ICU_Units,Approved_by_SMCOM,Password)
                     VALUES ('$id','$name', '$email','$address','$incname','$mob','$nat','$beds','$wards','$icu','$approved','" . md5($password) . "')";
...
?>
    <form class="form" action="" method="post">
        ...
        <br><br>
        <!--Upload abcd BMC Registration Certificate: <input type="file" id="img" name="bmc_certificate" required accept="image/*"><br><br><br><br>-->
